...
export default function Certification() {
  ...
  return (
    <section id="certification" className="py-20 bg-dark-bg text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex justify-between items-center w-full mb-12">
          <h2 className="font-unbounded text-3xl md:text-5xl font-black uppercase tracking-tight">
        ...
        <div 
          ref={sliderRef}
          className="scrollbar-none flex gap-6 overflow-x-auto snap-x snap-mandatory scroll-smooth pt-12 pb-12 -mt-12"
        >
          ...
          {certData.map((cert, index) => (
            ...
            >
              ...
              {/* SUNTIKAN EFEK BENTO AMBIENT GLOW (Tetap tebal sesuai keinginan Anda, dilapisi z-[-1] di belakang kartu) */}
